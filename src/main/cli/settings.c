...
// PG_AUTOPILOT
    ...
    { PARAM_NAME_AP_POS_CHIRP_LAG_FREQ_HZ_DECI,   VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 255 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, posChirpLagFreqHzDeci) },
    { PARAM_NAME_AP_POS_CHIRP_LEAD_FREQ_HZ_DECI,  VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 255 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, posChirpLeadFreqHzDeci) },
  #endif
#endif // !USE_WING
